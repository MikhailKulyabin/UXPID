...
def main():
    ...
    parser.add_argument("--target-field", choices=["topics", "topic_status", "topic_type", "overall_thread_sentiment"], 
                       default=DATA_CONFIG["target_field"],
                       help="Target field for classification: 'topics', 'topic_status', 'topic_type', or 'overall_thread_sentiment'")
